...
<template>
  <transition name="fade">
    <div v-if="isVisible" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60" @click.self="onClose">
      <div class="relative bg-[#181c24] shadow-lg min-w-[320px] max-w-[90vw] w-[700px] max-h-[85vh] border-2 border-gray-600 rounded-lg overflow-hidden flex flex-col">
        <!-- 头部区域 -->
        ...
        <!-- 分割线 -->
        <div class="h-px bg-gray-700 mx-6 flex-shrink-0" />

        <!-- 内容区域 - 使用独立的滚动容器，确保底部有足够空间 -->
